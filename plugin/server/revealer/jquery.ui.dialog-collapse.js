        ...
        if(this.options.collapseEnabled) {
            this.addCollapseButton = function() {
                ...
                if(!this.uiDialogTitlebarCollapse) {
                    ...
                    this.uiDialogTitlebarCollapse = $(
                    '<button type="button" title="Compress" aria-label="Compress" class="pretiusCompressBtn t-Button t-Button--noLabel t-Button--icon t-Button--small"><span aria-hidden="true" class="t-Icon fa fa-compress"></span></button>'
                    )
                    .appendTo( this.uiDialogTitlebar )
                    .insertBefore( $(this.uiDialogTitlebar).find( '.ui-dialog-titlebar-close' ) );
            ...
            this.addCollapseRestoreButton = function() {
                ...
                if(!this.uiDialogTitlebarCollapseRestore){
                    this.uiDialogTitlebarCollapseRestore = $(
                        '<button type="button" title="Expand" aria-label="Expand" class="pretiusExpandBtn t-Button t-Button--noLabel t-Button--icon t-Button--small"><span aria-hidden="true" class="t-Icon fa fa-expand"></span></button>'
                        )
                    .insertBefore( $(this.uiDialogTitlebar).find( '.ui-dialog-titlebar-close' ) );
