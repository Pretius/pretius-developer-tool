pdt.pretiusContentRevealer = (function () {
    ...
    var frameworkArray = ['pFlowId', 'pFlowStepId', 'pInstance', 'pPageSubmissionId', 'pRequest', 'pReloadOnSubmit', 'pSalt', 'pPageItemsRowVersion', 'pPageItemsProtected', 'pdebug', 'apexCBMDummySelection', 'pPageChecksum', 'p_md5_checksum', 'pPageFormRegionChecksums'];
    ...
    function apexDevToolbarRevealer(pMode) {
        ...
        $("#pretiusRevealerInline .t-DialogRegion-body").load(pdt.opt.filePrefix + "revealer.html");
